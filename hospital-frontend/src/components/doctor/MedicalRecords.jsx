    ...
    <div className="space-y-6 p-6 bg-gray-50 dark:bg-gray-900 min-h-screen">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-1">View and manage laboratory test results</p>
        </div>
        <button
          onClick={() => {
            setTestRequestForm({
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div className="text-left">
              <p className="font-semibold text-gray-900 dark:text-white">Request New Test</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Order lab tests for patient</p>
            </div>
          </button>
          ...
          >
            <div className="p-3 bg-green-100 dark:bg-green-900/40 rounded-lg group-hover:bg-green-500 transition-colors">
              <TrendingUp className="w-6 h-6 text-green-600 dark:text-green-400 group-hover:text-white" />
            </div>
            <div className="text-left">
              <p className="font-semibold text-gray-900 dark:text-white">View Analytics</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Test results trends</p>
            </div>
          </button>
          ...
          >
            <div className="p-3 bg-purple-100 dark:bg-purple-900/40 rounded-lg group-hover:bg-purple-500 transition-colors">
              <ClipboardList className="w-6 h-6 text-purple-600 dark:text-purple-400 group-hover:text-white" />
            </div>
            <div className="text-left">
              <p className="font-semibold text-gray-900 dark:text-white">Generate Report</p>
              <p className="text-sm text-gray-500 dark:text-gray-400">Create summary report</p>
            </div>
          </button>
        </div>
      </div>
      ...
      <div className="space-y-4">
        {filteredReports.length === 0 ? (
          ...
          filteredReports.map((report) => (
            <div key={report.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6 hover:shadow-md transition-shadow border border-gray-100 dark:border-gray-700">
                ...
                <div className="flex items-start space-x-4 flex-1">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between mb-3">
                      <div>
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-white">{report.patient}</h3>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-sm text-gray-700 dark:text-gray-300 capitalize">{report.testType}</span>
                      </div>
                      <div className="flex items-center space-x-2">
                        <span className="text-sm text-gray-700 dark:text-gray-300">{report.lab}</span>
                      </div>
                      <div>
                        <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Report: {report.id}</span>
                      </div>
                    </div>
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg mb-3">
                      ...
                      <p className="text-sm text-gray-900 dark:text-gray-100">{report.notes}</p>
                    </div>

                    {report.doctorNotes && (
                      <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg border border-green-200 dark:border-green-800">
                        <p className="text-xs text-green-700 dark:text-green-400 mb-1 font-medium">Doctor's Notes</p>
                        <p className="text-sm text-green-800 dark:text-green-300">{report.doctorNotes}</p>
                      </div>
                    )}
                  </div>
                </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Lab Report Details</h3>
              <button
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div>
                  ...
                  <p className="font-semibold text-gray-900 dark:text-white">{selectedReport.patient}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Test Name</p>
                  <p className="font-semibold text-gray-900 dark:text-white">{selectedReport.testName}</p>
                </div>
                <div>
                  <p className="text-sm text-gray-600 dark:text-gray-400">Date</p>
                  <p className="font-semibold text-gray-900 dark:text-white">{selectedReport.date}</p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className={`p-4 rounded-lg ${
                    selectedReport.result === 'Normal' ? 'bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800' :
                    selectedReport.result === 'Critical' ? 'bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800' :
                    'bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800'
                  }`}>
                    <div className="flex items-center justify-between mb-2">
                      <p className="font-medium text-lg dark:text-white">{selectedReport.result}</p>
                      {getResultBadge(selectedReport.result)}
                    </div>
                    <p className="text-gray-700 dark:text-gray-300">{selectedReport.notes}</p>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full h-32 p-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                  />
                </div>
              </div>
            </div>
      ...
      {showAnalyticsModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Lab Reports Analytics</h3>
              <button
            ...
            <div className="p-6 space-y-6">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                  ...
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">{analyticsData.totalTests}</p>
                </div>
                <div className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg">
                  <p className="text-sm text-gray-600 dark:text-gray-400">Completed</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">{analyticsData.completedTests}</p>
                </div>
                <div className="bg-yellow-50 dark:bg-yellow-900/20 p-4 rounded-lg">
                  <p className="text-sm text-gray-600 dark:text-gray-400">Pending</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">{analyticsData.pendingTests}</p>
                </div>
                <div className="bg-red-50 dark:bg-red-900/20 p-4 rounded-lg">
                  <p className="text-sm text-gray-600 dark:text-gray-400">Abnormal</p>
                  <p className="text-2xl font-bold text-gray-900 dark:text-white">{analyticsData.abnormalResults}</p>
                </div>
              </div>
                    ...
                    {analyticsData.monthlyTrend.map((month, index) => (
                      <div key={index} className="flex items-center justify-between text-sm">
                        ...
                        <div className="flex items-center space-x-4">
                          <span className="text-gray-600 dark:text-gray-400">{month.tests} tests</span>
                          <span className="text-red-600 dark:text-red-400">{month.abnormal} abnormal</span>
                        </div>
                      </div>
                    ))}
                  </div>
      ...
      {showGenerateReportModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-xl max-w-md w-full">
            <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Generate Summary Report</h3>
              <button
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <select className="w-full p-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
      ...
      {showRequestModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-xl max-w-md w-full">
            <div className="sticky top-0 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-4 flex items-center justify-between">
              <h3 className="text-xl font-bold text-gray-900 dark:text-white">Request New Lab Test</h3>
              <button
